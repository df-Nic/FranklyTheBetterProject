...
const PayNowAmountPage = () => {
  ...
  return (
    <div className="flex-1 w-full bg-[#F5F5F7] flex flex-col min-h-0 relative overflow-hidden select-none">
      ...
      {/* Content */}
      <div className="flex-1 overflow-y-auto scroll-ios no-scrollbar px-4 py-5 flex flex-col gap-6 z-10 pb-10 touch-pan-y min-h-0">
        {/* Recipient Details */}
        ...
        {showAccountDrawer && (
          <>
            ...
            >
              ...
              {/* Accounts list */}
              <div className="flex-1 overflow-y-auto scroll-ios p-4 flex flex-col gap-3">
