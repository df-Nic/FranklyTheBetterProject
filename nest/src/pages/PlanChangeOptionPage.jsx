...
const CONTEXT_CONFIG = {
  deposit: {
    ...
    alternatives: [
      ...
      },
      {
        ...
        type: "deposit product",
        tags: ["Higher interest", "Fewer conditions"],
        fitText: "Only where maturity is before the next goal payment to guarantee principal safety."
      },
      {
        id: "alt_premier_div",
        ...
        type: "deposit product",
        tags: ["Higher interest", "Easier access"],
        fitText: "Provides high interest yield while maintaining daily liquidity access."
      }
    ]
  },
  auto_transfer: {
    ...
    alternatives: [
      {
        ...
        fitText: "Matures in 6 months before your goal payment with state-backed security."
      },
      {
        id: "alt_tbill_1y",
  ...
  robo_invest: {
    ...
    alternatives: [
      {
        id: "alt_robo_low_vol",
        name: "Lower-volatility portfolio",
        desc: "OCBC RoboInvest lower-volatility portfolio focusing on defensive global bonds and conservative ETF assets.",
        rate: 0.052,
      ...
      {
        id: "alt_robo_broad_div",
        name: "Broad diversified portfolio",
        desc: "OCBC RoboInvest broad diversified portfolio allocated across global equities, tech, and fixed income.",
        rate: 0.068,
        type: "roboinvest portfolio",
        tags: ["More diversified", "Lower fees"],
        fitText: "Broadens asset coverage across international equity markets with low fee overhead."
      },
      {
        id: "alt_robo_goal_matched",
        name: "Goal-matched portfolio within the same risk band",
        desc: "OCBC RoboInvest portfolio dynamically calibrated to match your specific goal target date and risk profile.",
        rate: 0.072,
        type: "roboinvest portfolio",
        tags: ["Easier access", "More diversified"],
        fitText: "Custom-calibrated to compound wealth over your designated goal timeline."
      }
    ]
  },
  blue_chip: {
    ...
    alternatives: [
      {
        id: "alt_bcip_shares",
        name: "Singapore blue-chip shares",
        desc: "Singapore blue-chip shares. Invest in premier SGX counters (e.g. OCBC, DBS, Singtel) from S$100/month.",
        rate: 0.055,
      ...
      {
        id: "alt_bcip_etfs",
        name: "Singapore-listed ETFs",
        desc: "Singapore-listed ETFs. Invest in STI ETF and S-REIT ETFs for instant broad market exposure and yields.",
        rate: 0.058,
        type: "recurring investment",
        tags: ["More diversified", "Different market exposure"],
        fitText: "Gains instant basket exposure to Singapore equities and real estate investment trusts."
      },
      {
        id: "alt_bcip_mix",
        name: "A diversified mix of eligible counters",
        desc: "A diversified mix of eligible counters combining top Singapore equities and high-yield REIT counters.",
        rate: 0.060,
        type: "recurring investment",
        tags: ["More diversified", "Different market exposure", "Lower monthly amount"],
        fitText: "Balances equity growth with regular passive dividend distributions without lock-in constraints."
      }
    ]
  },
  protection: {
