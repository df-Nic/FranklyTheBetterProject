...
export const PLANS_DATA = {
  ...
  housing: {
    id: "housing",
    title: "OCBC Housing Plan",
    goal: "Save for property downpayments, loan setup, and full home ownership",
    ...
    getByType: (type = 'hdb') => {
      if (type === 'condo') {
        return {
          id: "housing",
          title: "OCBC Condominium Housing Plan",
          goal: "Save for OTP booking deposit, S&P stamp duties (BSD), and full condo mortgage payoff",
          categories: [
            {
              id: "deposits",
              name: "Deposits & Liquidity",
              icon: "Coins",
              actions: [
                ...
                { id: "sav_fd_promo", name: "OCBC Fixed Deposit Sweep", desc: "Lock SG$30,000 idle cash in a promotional 6-month OCBC Fixed Deposit yielding 3.40% p.a. for OTP cash.", baseVal: 30000, rate: 0.034, type: "deposit", isLumpSum: true },
                { id: "sav_ocbc_money_max", name: "OCBC MoneyMax Liquidity Vault", desc: "Instant-access liquid yield vault yielding 3.85% p.a. to hold your BSD stamp duty buffer.", baseVal: 15000, rate: 0.0385, type: "deposit", isLumpSum: true }
              ]
            },
            {
              id: "loans",
              name: "Home Loans & Financing",
              icon: "Coins",
              actions: [
                { id: "sav_ocbc_home_loan", name: "OCBC Private Property SORA Loan", desc: "Finance your condo with an OCBC Private Home Loan pegged to 3M SORA at 2.90% p.a.", baseVal: 50000, rate: 0.029, type: "deposit", isLumpSum: true },
                { id: "sav_ocbc_ecogreen", name: "OCBC Eco-Green Mortgage Rate Lock", desc: "Secure green mortgage package rates with zero legal fee subsidy and rate-cap guarantees.", baseVal: 20000, rate: 0.0275, type: "deposit", isLumpSum: true }
              ]
            },
            {
              id: "investments",
              ...
              icon: "TrendingUp",
              actions: [
                { id: "sav_bcip_housing", name: "OCBC BCIP Blue Chip Share Plan", desc: "DCA SG$600/mo into high-yielding local blue chips and REITs to secure a steady 5.50% average growth rate.", baseVal: 7200, rate: 0.055, type: "investment" },
                { id: "sav_mmf", name: "Lion-OCBC Money Market Fund", desc: "Allocate SG$15,000 to low-risk liquidity funds for a flexible 3.90% p.a. return with instant liquidity.", baseVal: 15000, rate: 0.039, type: "yield", isLumpSum: true },
                { id: "sav_tbills", name: "Singapore Treasury Bills (T-Bills)", desc: "Buy 6-month risk-free Singapore Government Securities to capture 3.70% p.a. state-backed yields.", baseVal: 10000, rate: 0.037, type: "yield", isLumpSum: true }
              ]
            }
          ]
        };
      ...
      if (type === 'landed') {
        return {
          id: "housing",
          title: "OCBC Landed Property Plan",
          goal: "Accumulate capital for landed property OTP deposit, full downpayment, BSD tier taxes, and title clearance",
          categories: [
            {
              id: "deposits",
              name: "Premier Wealth & Liquidity",
              icon: "Coins",
              actions: [
                { id: "sav_premier_deposit", name: "OCBC Premier High-Yield Deposit", desc: "Earn up to 4.80% p.a. premier tier interest on liquid downpayment capital held with OCBC Premier Banking.", baseVal: 50000, rate: 0.048, type: "deposit", isLumpSum: true },
                { id: "sav_foreign_deposit", name: "OCBC Foreign Currency Note Sweep", desc: "Diversify treasury cash into USD/AUD yield notes at 4.20% p.a. risk-free.", baseVal: 30000, rate: 0.042, type: "deposit", isLumpSum: true }
              ]
            },
            {
              id: "loans",
              name: "Landed Financing & Legal",
              icon: "Coins",
              actions: [
                { id: "sav_landed_loan", name: "OCBC Landed Mortgage Specialist Loan", desc: "Custom floating/fixed mortgage structuring for landed titles offering a rate of 2.80% p.a.", baseVal: 80000, rate: 0.028, type: "deposit", isLumpSum: true },
                { id: "sav_equity_loan", name: "OCBC Custom Equity Term Loan", desc: "Unlock existing property equity buffers at low 2.95% p.a. interest to fund landed acquisition.", baseVal: 40000, rate: 0.0295, type: "deposit", isLumpSum: true }
              ]
            },
            {
              id: "investments",
              name: "Investments & Wealth Growth",
              icon: "TrendingUp",
              actions: [
                { id: "sav_robo_growth", name: "OCBC RoboInvest Growth Portfolio", desc: "Deploy SG$50,000 into high-growth global equity portfolios compounding at 7.20% p.a.", baseVal: 50000, rate: 0.072, type: "investment", isLumpSum: true },
                { id: "sav_global_core", name: "Lion-OCBC Global Core Equities Fund", desc: "Allocate SG$25,000 to global core equities compounding at 6.80% p.a.", baseVal: 25000, rate: 0.068, type: "investment", isLumpSum: true },
                { id: "sav_tbills", name: "Singapore Treasury Bills (T-Bills)", desc: "Risk-free 3.70% p.a. yield for BSD tax and legal conveyancing reserves.", baseVal: 20000, rate: 0.037, type: "yield", isLumpSum: true }
              ]
            }
          ]
        };
      ...
      return {
        id: "housing",
        title: "OCBC HDB (BTO) Housing Plan",
        goal: "Save for downpayments, loans, and full HDB home ownership",
        categories: [
          {
            id: "deposits",
            ...
            actions: [
              { id: "sav_ocbc360", name: "OCBC 360 Savings Account", desc: "Credit your salary and save SG$500/mo to hit up to 4.65% p.a. interest rate on your active deposits.", baseVal: 6000, rate: 0.0465, type: "deposit" },
              { id: "sav_bonus_plus", name: "OCBC Bonus+ Savings Account", desc: "High yield savings up to 3.70% p.a. with zero withdrawal penalties for key downpayment tranches.", baseVal: 10000, rate: 0.037, type: "deposit", isLumpSum: true }
            ]
          },
          {
            id: "grants_loans",
            name: "Grants & Home Loans",
            icon: "Coins",
            actions: [
              { id: "sav_cpf_grant", name: "Proximity Housing Grant (PHG)", desc: "Secure up to SG$30,000 in CPF Proximity Housing Grants by purchasing an HDB flat within 4km of parents.", baseVal: 30000, rate: 0.0, type: "grant", isLumpSum: true },
              { id: "sav_ehg_grant", name: "Enhanced CPF Housing Grant (EHG)", desc: "Access up to SG$80,000 in state housing support credited directly to your CPF Ordinary Account.", baseVal: 40000, rate: 0.0, type: "grant", isLumpSum: true },
              { id: "sav_ocbc_homeloan", name: "OCBC HDB Home Loan Package", desc: "Plan your HDB purchase with a competitive home loan package offering a low rate of 2.50% p.a.", baseVal: 50000, rate: 0.025, type: "deposit", isLumpSum: true }
            ]
          },
          {
            id: "investments",
